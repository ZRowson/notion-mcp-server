"""
Notion MCP Server - HTTP Version

This module implements a Model Context Protocol server that provides
integration with Notion via HTTP/SSE transport for remote access.
"""
...
def create_database_entry(database_id: str, properties: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Args:
        ...
        properties: Dictionary of properties for the new entry
...
# ============================================================================
# MAIN ENTRY POINT - HTTP/SSE MODE
# ============================================================================
...
def main():
    ...
    logger.info(f"Starting Notion MCP Server (HTTP/SSE mode) on {host}:{port}")
